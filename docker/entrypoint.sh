...
mkdir -p "${CONFIG_DIR}" "${APP_ROOT}/data" "${APP_ROOT}/db" "${APP_ROOT}/logs" /run/php
...
chown -R www-data:www-data "${CONFIG_DIR}" "${APP_ROOT}/data" "${APP_ROOT}/db" "${APP_ROOT}/logs" /run/php
